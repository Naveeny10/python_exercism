...
def remove_suffix_ness(word):
    ...
    pass
    suffix_word=word[:-4]
    if suffix_word.endswith('i'):
        suffix_word=suffix_word[:-1]+'y'
    return suffix_word
...
def adjective_to_verb(sentence, index):
    ...
    pass
    adjactive_word=sentence.split()[index]
    if adjactive_word.endswith('.'):
        adjactive_word=adjactive_word[:-1]
    return adjactive_word+'en'
