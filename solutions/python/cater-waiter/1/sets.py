...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    pass
    dish=[dish_name]
    dish.append(set(dish_ingredients))
    return tuple(dish)
...
def check_drinks(drink_name, drink_ingredients):
    ...
    pass
    drink=drink_name + " Mocktail" if set(drink_ingredients).isdisjoint(ALCOHOLS) else (drink_name +" Cocktail")
    return drink
...
def tag_special_ingredients(dish):
    ...
    pass
    a,ingredient=dish
    special_ingreadient=set(ingredient).intersection(SPECIAL_INGREDIENTS)
    return (a,special_ingreadient)
...
def compile_ingredients(dishes):
    ...
    pass
    all_dish=set()
    for each_dish in dishes:
        all_dish=all_dish.union(each_dish)
    return all_dish
...
def singleton_ingredients(dishes, intersection):
    ...
    for each_dish in dishes:
        all_ingredients = all_ingredients.union(each_dish)
