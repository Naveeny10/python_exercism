...
def round_scores(student_scores):
    ...
    for scores in student_scores:
        round_score.append(round(scores))
    return round_score
...
def above_threshold(student_scores, threshold):
    ...
    pass
    above_threshold_student=[]
    for scores in student_scores:
        if scores>=threshold:
            above_threshold_student.append(scores)
    return above_threshold_student
...
def student_ranking(student_scores, student_names):
    ...
    for i in range(1,len(student_names)+1):
        rank_student.append(str(i)+'. '+student_names[i-1]+': '+str(student_scores[i-1]))
    return rank_student
